...
These are canonical role names. The actual label strings used in the issue tracker may differ. The mapping should have been provided to you in `docs/agents/triage-labels.md`. If it is missing, ask the user for their label strings; if they don't have any, use the canonical names as the labels.
